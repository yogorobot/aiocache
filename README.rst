...
- **serializers**: Serialize and deserialize the data between your code and the backends. This allows you to save any Python object into your cache. Currently supporting: StringSerializer, PickleSerializer, DillSerializer, JsonSerializer, ORJsonSerializer, and MsgPackSerializer. But you can also build custom ones.
